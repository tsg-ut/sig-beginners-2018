...
__問題1__<br>
a=[2,3,5,4,42,625,2,7,52,435,46]の平均をsum,lenを用いずにfor、while(len使っていいです)の2通りで実装してみてください。

__問題2__<br>
"".join(list(map(str,a)))（aの各要素を文字列として繋げたもの）をfor,whileの2通りで求めてください。（想定別解あり）

***

##### オマケ
解説しきれない内容が多いので、困ったら[ドキュメント](https://www.python.org/doc/)を見ましょう。